...
- Colored text is encoded as displayed text inside `{fc(...)...}` markup. An early extraction pass mistakenly protected some of those bodies; a targeted corpus repair is being applied before the first public snapshot.
